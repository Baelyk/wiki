<?php
    ...
    function getThePage ($nullProtect) {
        if($nullProtect) {
            return isset( $page ) ? $page : "select_page";
        }
    }
?>
<!DOCTYPE html>
<html>
    ...
    <body>
        ...
        <div id="sidebar" class="sidebar">
            <a href=<?php echo "?page=" . getThePage(TRUE) . "&edit=on"; ?>>Edit Page</a>
            <a href=<?php echo "?page=" . getThePage(TRUE); ?>>Read Page</a>
            <hr />
            <a href="/wiki/?page=createpage">Create Page</a>
            <hr />
            <form class="selectpage" action="/wiki/search.php" method="get">
                <input id="search" class="search" type="text" name="page" value="Search..." />
                <input type="submit" name="selectpage" value="Go">
            </form>
        </div>
